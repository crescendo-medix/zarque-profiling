...
from zarque_profiling.__init__ import ProfileReport, __version__
from zarque_profiling.utils.dataframe import read_pandas


def parse_args(args: Optional[List[Any]] = None) -> argparse.Namespace:
    """Parse the command line arguments for the `zarque_profiling` binary.
...
def main(args: Optional[List[Any]] = None) -> None:
    """Run the `zarque_profiling` package.
