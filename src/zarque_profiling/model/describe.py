...
from zarque_profiling.model.alerts import get_alerts
...
from zarque_profiling.model.missing import get_missing_active, get_missing_diagram
from zarque_profiling.model.pairwise import get_scatter_plot, get_scatter_tasks
from zarque_profiling.model.sample import get_custom_sample, get_sample
from zarque_profiling.model.summarizer import BaseSummarizer
from zarque_profiling.model.summary import get_series_descriptions
from zarque_profiling.model.table import get_table_stats
from zarque_profiling.utils.progress_bar import progress
...
def describe(
    ...
    with tqdm(
        ...
        package = {
            "zarque_profiling_version": __version__,
            "zarque_profiling_config": config.json(),
        }
        pbar.update()
