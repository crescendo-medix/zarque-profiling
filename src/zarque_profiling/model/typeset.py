...
from zarque_profiling.model.typeset_relations import (
    category_is_numeric,
    category_to_numeric,
    numeric_is_category,
    series_is_string,
...
polars_has_string_dtype_flag = hasattr(pdt, "is_string_dtype")
    ...
    class Categorical(visions.VisionsBaseType):
        ...
        def contains_op(series: pd.Series, state: dict) -> bool:
            ...
            if is_valid_dtype:
                ...
                return polars_has_string_dtype_flag and pdt.is_string_dtype(series)
