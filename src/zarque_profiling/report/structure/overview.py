...
from zarque_profiling.report.formatters import (
    fmt,
    fmt_bytesize,
    fmt_number,
    fmt_numeric,
...
from zarque_profiling.report.presentation.core import Alerts, Container, Table
...
def get_dataset_reproduction(config: Settings, summary: dict) -> Renderable:
    ...
    version = summary["package"]["zarque_profiling_version"]
    config_file = summary["package"]["zarque_profiling_config"]
    ...
    def fmt_version(version: str) -> str:
        return f'<a href="https://crescend_medix.com/zarque/zarque-profiling">zarque-profiling v{version}</a>'
