...
from zarque_profiling.model.handler import get_render_map
from zarque_profiling.report.presentation.core import (
    HTML,
    Collapse,
    Container,
    Dropdown,
...
from zarque_profiling.report.presentation.core import Image as ImageWidget
from zarque_profiling.report.presentation.core import Sample, ToggleButton, Variable
...
from zarque_profiling.report.structure.correlations import get_correlation_items
from zarque_profiling.report.structure.overview import get_dataset_items
from zarque_profiling.utils.dataframe import slugify
...
def get_report_structure(config: Settings, summary: dict) -> Root:
    ...
    footer = HTML(
        content='Report generated by <a href="https://crescendo_medix.com/">Crescendo Medix</a>.'
    )
